...
sudo scutil --set ComputerName "mesm"
sudo scutil --set HostName "mesm"
sudo scutil --set LocalHostName "mesm"
sudo defaults write /Library/Preferences/SystemConfiguration/com.apple.smb.server NetBIOSName -string "mesm"
...
tell application "Terminal"
	...
	do shell script "open '$HOME/dotfiles/colors/osx-terminal/xterm-256color/" & themeName & ".terminal'"
